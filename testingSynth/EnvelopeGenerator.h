...
public:
    ...
    double testSetSampleRate(double newSampleRate);
    ...
    double testSetStageValue(EnvelopeStage stage, double value);
    double testCalculateMultiplier(double startLevel, double endLevel, unsigned long long lengthInSamples);
