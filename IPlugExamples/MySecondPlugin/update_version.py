...
def main():
  ...
  plistpath = scriptpath + "/resources/MySecondPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySecondPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySecondPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySecondPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySecondPlugin-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MySecondPlugin-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MySecondPlugin-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MySecondPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MySecondPlugin.iss",inplace=1):
